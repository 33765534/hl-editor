...
export default {
  ...
  data() {
    return {
      ...
      iconCode:
        "https://static.imonkey.xueersi.com/download/vcc-resource/icon/code-working-outline.svg",
      iconClear:
        "https://static.imonkey.xueersi.com/download/vcc-resource/icon/trash-outline.svg",
